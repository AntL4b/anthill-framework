...
describe('AHCorsMiddleware', () => {
  test('No body specified - default behaviour', async () => {
    ...
    const middlewareResponse = await middleware.runAfter(response, AHTestResource.getBaseEvent(), AHTestResource.getBaseContext())
  ...
  test('Option credentials', async () => {
    ...
    const middlewareResponse2 = await middleware2.runAfter(response2, AHTestResource.getBaseEvent(), AHTestResource.getBaseContext());
    ...
    const middlewareResponse3 = await middleware2.runAfter(response3, AHTestResource.getBaseEvent(), AHTestResource.getBaseContext());
